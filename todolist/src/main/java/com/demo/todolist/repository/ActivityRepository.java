...
public interface ActivityRepository extends JpaRepository<Activity, String>{
    ...
    @Query(value = "select * from t_activity left join t_category ON t_activity.category_id = t_category.id where end_time < now() AND t_activity.is_active = true", nativeQuery = true)
